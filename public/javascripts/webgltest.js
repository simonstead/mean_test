...
// var map = new THREE.TextureLoader().load( "images/mons/mons8.png" );
...
var lesson1 = {
    ...
    init: function() { // Initialization
        ...
        // add cylinder shape
        var cylinder = new THREE.Mesh(new THREE.CylinderGeometry(60, 80, 90, 32), new THREE.MeshLambertMaterial({ color: this.getRandColor() }));
        cylinder.rotation.x = cube.rotation.z = Math.PI * 0.1;
        cylinder.position.x = -300;
        cylinder.position.y = 150;
        cylinder.position.z = 100;
        cylinder.castShadow = cube.receiveShadow = true;
